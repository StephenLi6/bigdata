...
public class ZkStudy {
    ...
    public  void  getDatas() throws Exception {
        ...
        //获取zk的客户端
        CuratorFramework client = CuratorFrameworkFactory.newClient("node1:2181", new ExponentialBackoffRetry(6000, 6));
        client.start();
        byte[] bytes = client.getData().forPath("/createNode02");
